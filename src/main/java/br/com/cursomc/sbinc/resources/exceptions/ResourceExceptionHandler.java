...
import br.com.cursomc.sbinc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> argumentNotValid(MethodArgumentNotValidException e, HttpServletRequest request) {
		...
		e.getBindingResult().getFieldErrors().stream().forEach(x -> err.addErrors(x.getField(), x.getDefaultMessage()));
